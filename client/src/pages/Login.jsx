    ...
    <div className='flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400'>
       ...
       <div className='bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm'>
        ...
        <form onSubmit={onSubmitHandler}>
          ...
          <p onClick={()=> navigate('/reset-password')} className='mb-4 text-indigo-500 cursor-pointer'>Froget Password</p>
          ...
          {state === 'Sign Up' ? ( <p className='text-gray-500 text-center text-xs mt-2'>Already have an account?{'  '}
            <span onClick={() =>{setState('Login')}} className='text-blue-400 cursor-pointer underline'>Login here</span>
          </p>) : (
          <p className='text-gray-500 text-center text-xs mt-2'>Don't have an account?{'  '}
